...
class YEAnimationTool {
    static var share : YEAnimationTool = YEAnimationTool()
...
extension YEAnimationTool {
    func animationForHeart() {
        ...
        let name = String(format: "YEDomain.bundle/heart%d.png", imageName)
